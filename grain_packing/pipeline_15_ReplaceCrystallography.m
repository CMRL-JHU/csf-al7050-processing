...
path_file_output_figures    = "./pipeline_output/15-synthetic_grains.pdf";
% groups
...
plot_pole_figures(orientations_old       , 'dream3d', path_file_output_figures)
plot_pole_figures(orientations_population, 'ebsd'   , path_file_output_figures)
plot_pole_figures(orientations_new       , 'new'    , path_file_output_figures)
